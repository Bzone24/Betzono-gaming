                ...
                <div class="cron-modal-header">
                    <div class="modal-header-top">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i
                                class="las la-calendar text--primary"></i> <?php echo app('translator')->get('Please Set Cron Job'); ?> </h5>
                ...
                <div class="form-group">
                    <div class="justify-content-between d-flex flex-wrap mb-1">
                        ...
                        <small class="fst-italic">
                            ...
                            <strong><?php echo e(gs('last_cron') ? diffForHumans(gs('last_cron')) : 'N/A'); ?></strong>
                        </small>
                    </div>
                    <div class="input-group">
                        ...
                        <button type="button" class="input-group-text copy-text-btn copyCronPath text--primary"><i
                                class="fas fa-copy"></i> <span class="copyText text--primary"><?php echo app('translator')->get('Copy'); ?></span>
                        </button>
                    </div>
                </div>
                <div class="justify-content-between cron-btn-group d-flex gap-2">
                    <a href="<?php echo e(route('admin.cron.index')); ?>" class="btn btn-outline--primary  w-100 h-45"><i
                            class="fas fa-cog"></i> <?php echo app('translator')->get('Cron Job Setting'); ?></a>
                    <a href="<?php echo e(route('cron')); ?>?target=all" class="btn btn-outline--warning w-100 h-45"><i
                            class="fas fa-bolt"></i> <?php echo app('translator')->get('Run Manually'); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\betzono.com\core\resources\views/admin/partials/cron_modal.blade.php ENDPATH**/ ?>